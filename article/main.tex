...
\usepackage{caption,subcaption,amsmath,amssymb,amsthm,graphicx,hyperref}

\graphicspath{{graphics/}} % where to look for image files
\addbibresource{references.bib} % separate file for bibtex references
...
% modular contents
\input{abstract.tex} % for a page break, use \newpage  
